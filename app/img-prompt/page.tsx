...
export default function ImgPromptPage() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.6rem', fontWeight: 900, marginBottom: '0.4rem' }}>AI 이미지 프롬프트 변환기</h1>
      <p style={{ color: '#d5def3', marginBottom: '1.2rem', fontSize: '0.9rem' }}>한국어 설명을 AI 이미지 생성용 영어 프롬프트로 변환합니다.</p>
      ...
      <div style={cardStyle}>
        ...
        <button style={{ ...btnStyle, marginTop: 16, width: '100%' }} onClick={convert} disabled={loading}>
          {loading ? '변환 중...' : '프롬프트 변환'}
        </button>
      </div>
